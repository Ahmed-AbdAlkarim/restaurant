...
<!-- Navbar الخاصة بتسجيل الدخول -->
        <div class="container-xxl position-relative p-0 bg-light py-3 shadow fixed-top">
            <div class="d-flex justify-content-between align-items-center px-4">
                <a href="{{ route('switchLang', ['lang' => app()->getLocale() == 'en' ? 'ar' : 'en']) }}" class="btn btn-outline-primary">
                    {{ trans('site.SwitchLangText') }}
                </a>
                        ...
                        @auth
                            @if(Auth::user()->role == 'admin')
                                <li class="nav-item mx-2">
                                    <a class="btn btn-outline-success" href="{{ url('/admin') }}">لوحة التحكم</a>
                                </li>
                            @endif
                        @endauth  
                        @guest
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <p class="text-white animated slideInLeft mb-4 pb-2">{{ $about->description_1 }}</p>
            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link" href="{{ url('/booking') }}">Book A Table</a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a class="border-bottom" href="https://www.facebook.com/share/1Gpgj7D7AG/?mibextid=qi2Omg"  target="_blank">Ahmed Abd-Alkarim</a><br><br>
                        </div>
                    </div>
                </div>
            </div>
